...
use Guzzle\Http\Handler\CurlHandler;
use Guzzle\Http\Handler\CurlMultiHandler;
use Guzzle\Http\Handler\Proxy;
use Guzzle\Http\Handler\StreamHandler;
...
function choose_handler(): callable
{
    ...
    if (\ini_get('allow_url_fopen')) {
        ...
        throw new \RuntimeException('Guzzle\Http requires cURL, the '
...
function default_user_agent(): string
{
    ...
    if (!$defaultAgent) {
        $defaultAgent = 'Guzzle\Http/Guzzle';
