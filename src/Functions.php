...
class Functions
{
     ...
     *                        format: "Name: Value"
     */
    public static function headers_from_lines($lines): array
    {
        $headers = [];
     ...
     */
    public static function is_host_in_noproxy(string $host, array $noProxyArray): bool
    {
        if (\strlen($host) === 0) {
     ...
     * @internal
     */
    public static function _current_time()
    {
     ...
     * @internal
     */
    public static function _idn_uri_convert(UriInterface $uri, int $options = 0): UriInterface
    {
        if ($uri->getHost()) {
     ...
     * @internal
     */
    public static function _getenv(string $name): ?string
    {
